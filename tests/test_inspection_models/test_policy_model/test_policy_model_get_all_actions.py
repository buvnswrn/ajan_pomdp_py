...
class TestPolicyModelGetAllActions(unittest.TestCase):
    ...
    def test_get_all_actions_2_left_false_2_2(self):
        ...
        actions = self.policy_model.get_all_actions(state)
        print(actions)
        self.assertEqual(set(actions), {MoveUp, MoveDown})
    ...
    def test_get_all_actions_1_left_false_1_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
    ...
    def test_get_all_actions_1_left_false_1_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
    ...
    def test_get_all_actions_1_left_false_1_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
    ...
    def test_get_all_actions_1_left_true_1_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_1_left_true_1_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    # def test_get_all_actions_1_left_true_1_0(self):
    #     state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
    #                                                  {"rack_id": 1, "inspection_state": 0},
    #                                                  ["rack_id", "inspection_state"]),
    #                          100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_2_right_false_2_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 2, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_2_right_false_2_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 2, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_2_right_false_2_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 2, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_3_right_false_3_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 3, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
                                                 ...
                                                 ["rack_id", "direction", "complete_status"])})
        actions = self.policy_model.get_all_actions(state)
        self.assertEqual(set(actions), {Perceive})

    def test_get_all_actions_3_right_false_3_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 3, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_3_right_false_3_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 3, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_4_right_false_4_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 4, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_4_right_false_4_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 4, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_4_right_false_4_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 4, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
                                                 ...
                                                 ["rack_id", "direction", "complete_status"])})
        actions = self.policy_model.get_all_actions(state)
        self.assertEqual(set(actions), {MoveDown})

    def test_get_all_actions_2_right_true_2_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 2, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
                                                 ...
                                                 ["rack_id", "direction", "complete_status"])})
        actions = self.policy_model.get_all_actions(state)
        self.assertEqual(set(actions), {MoveLeft})

    def test_get_all_actions_2_right_true_2_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 2, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_3_right_true_3_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 3, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_3_right_true_3_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 3, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_4_right_true_4_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 4, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_4_right_true_4_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 4, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_1_right_false_1_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_1_right_false_1_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_1_right_false_1_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
                                                 ...
                                                 ["rack_id", "direction", "complete_status"])})
        actions = self.policy_model.get_all_actions(state)
        self.assertEqual(set(actions), {MoveUp})

    def test_get_all_actions_1_right_true_1_1(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 1},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_1_right_true_1_2(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 2},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_1_right_true_1_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 1, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_2_right_true_2_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 2, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_3_right_true_3_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 3, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_4_right_true_4_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 4, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_2_left_true_2_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 2, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_3_left_true_3_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 3, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
    ...
    def test_get_all_actions_4_left_true_4_0(self):
        state = AjanOOState({112: AjanEnvObjectState("Shelf", 115,
                                                     {"rack_id": 4, "inspection_state": 0},
                                                     ["rack_id", "inspection_state"]),
                             100: AjanAgentState("Drone", 100,
